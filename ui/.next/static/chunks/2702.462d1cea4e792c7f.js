"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2702],{3605:function(t,e,o){o.d(e,{D:function(){return p}});var i=o(7250),r=o(1589);(0,r.e)(),(0,r.e)(),(0,r.e)();var n=(0,i.C)`
  * {
...
`,p=t=>{var e;class o extends t{constructor(){super(...arguments),this.unsubscribeFrom=[],this.useStore=r.l.bind(this)}connectedCallback(){setTimeout(()=>{var t,e;let o=document.getElementById("superviz-style"),i=this.createCustomColors(),r=document.createElement("style");r.innerHTML=(null==o?void 0:o.innerHTML)||"",null==(t=this.shadowRoot)||t.appendChild(r),i&&(null==(e=this.shadowRoot)||e.appendChild(i))}),super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeFrom.forEach(t=>t(this))}createCustomColors(){if(!r.f.get("colors"))return;let t=document.createElement("style"),e=Object.entries(r.f.get("colors")).map(([t,e])=>`--${t}: ${e} !important;`).join(" ");return t.innerHTML=`
      * {
        ${e}
      }
    `,t}emitEvent(t,e,o={composed:!0,bubbles:!0}){let i=new CustomEvent(t,(0,r.x)({detail:e},o));this.dispatchEvent(i)}}return o.styles=[n,a,s,c,null!=(e=t.styles)?e:[]],o}},9583:function(t,e,o){o.d(e,{a:function(){return c},c:function(){return d},d:function(){return b},g:function(){return v},i:function(){return n},l:function(){return g},m:function(){return m},n:function(){return s},p:function(){return l},r:function(){return a},s:function(){return p},x:function(){return x}});var i=o(7250),r=o(1589);(0,r.e)();var n=(0,i.C)`
  .superviz-comments {
    --offset-left: 10px;
    --offset-right: 10px;
    --offset-top: 10px;
