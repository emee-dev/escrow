"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7585],{3605:function(t,e,o){o.d(e,{D:function(){return l}});var n=o(7250),r=o(1589);(0,r.e)(),(0,r.e)(),(0,r.e)();var i=(0,n.C)`
  * {
...
`,a=(0,n.D)(r.a),d=[a.styles,s],l=class extends a{constructor(){super(...arguments),this.getContainer=()=>window.document.querySelector("superviz-modal-container"),this.createContainer=t=>{this.modal=document.createElement("superviz-modal-container"),this.modal.setOptions(t)},this.createModal=({detail:t})=>{this.createContainer(t),window.document.body.appendChild(this.modal)},this.destroyModal=()=>{var t;this.modal=void 0,null==(t=this.getContainer())||t.remove()}}firstUpdated(){window.document.body.addEventListener("superviz-modal--open",this.createModal),window.document.body.addEventListener("superviz-modal--close",this.destroyModal)}disconnectedCallback(){this.destroyModal(),window.document.body.removeEventListener("superviz-modal--open",this.createModal),window.document.body.removeEventListener("superviz-modal--close",this.destroyModal)}};l.styles=d,l=(0,i.D)([(0,r.t)("superviz-modal")],l),(0,i.e)();var c=(0,n.D)(r.a),p=[c.styles,s],v=class extends c{constructor(){super(...arguments),this.closeModal=()=>{window.document.body.dispatchEvent(new CustomEvent("superviz-modal--close",{bubbles:!0,composed:!0}))},this.confirmModal=()=>{window.document.body.dispatchEvent(new CustomEvent("superviz-modal--confirm",{bubbles:!0,composed:!0}))}}setOptions(t){this.options=t}render(){return(0,r.V)`
      <div class="modal--overlay"></div>
      <div class="modal--container">
        <div class="modal">${(0,r.V)`
      ...
      `} ${(()=>{if(this.options.footer)return(0,r.V)` <div class="modal--footer">${this.options.footer}</div> `;let t=this.options.confirmLabel||"OK",e=this.options.cancelLabel||"Cancel";return this.options.confirm&&this.options.cancel?(0,r.V)`
    ...
    `}};v.styles=p,v=(0,i.D)([(0,r.t)("superviz-modal-container")],v)}}]);