"use strict";exports.id=592,exports.ids=[592],exports.modules={8882:(t,e,o)=>{o.d(e,{D:()=>c});var i=o(7128),r=o(6955);(0,r.e)(),(0,r.e)(),(0,r.e)();var n=(0,i.C)`
  * {
...
`,c=t=>{var e;class o extends t{constructor(){super(...arguments),this.unsubscribeFrom=[],this.useStore=r.l.bind(this)}connectedCallback(){setTimeout(()=>{var t,e;let o=document.getElementById("superviz-style"),i=this.createCustomColors(),r=document.createElement("style");r.innerHTML=(null==o?void 0:o.innerHTML)||"",null==(t=this.shadowRoot)||t.appendChild(r),i&&(null==(e=this.shadowRoot)||e.appendChild(i))}),super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeFrom.forEach(t=>t(this))}createCustomColors(){if(!r.f.get("colors"))return;let t=document.createElement("style"),e=Object.entries(r.f.get("colors")).map(([t,e])=>`--${t}: ${e} !important;`).join(" ");return t.innerHTML=`
      * {
        ${e}
      }
    `,t}emitEvent(t,e,o={composed:!0,bubbles:!0}){let i=new CustomEvent(t,(0,r.x)({detail:e},o));this.dispatchEvent(i)}}return o.styles=[n,a,s,p,null!=(e=t.styles)?e:[]],o}},8782:(t,e,o)=>{o.d(e,{a:()=>p,c:()=>d,d:()=>b,g:()=>v,i:()=>n,l:()=>g,m:()=>m,n:()=>s,p:()=>l,r:()=>a,s:()=>c,x:()=>x});var i=o(7128),r=o(6955);(0,r.e)();var n=(0,i.C)`
  .superviz-comments {
    --offset-left: 10px;
    --offset-right: 10px;
    --offset-top: 10px;
