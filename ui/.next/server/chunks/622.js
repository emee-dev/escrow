"use strict";exports.id=622,exports.ids=[622],exports.modules={8882:(e,t,i)=>{i.d(t,{D:()=>p});var o=i(7128),s=i(6955);(0,s.e)(),(0,s.e)(),(0,s.e)();var n=(0,o.C)`
  * {
...
`,p=e=>{var t;class i extends e{constructor(){super(...arguments),this.unsubscribeFrom=[],this.useStore=s.l.bind(this)}connectedCallback(){setTimeout(()=>{var e,t;let i=document.getElementById("superviz-style"),o=this.createCustomColors(),s=document.createElement("style");s.innerHTML=(null==i?void 0:i.innerHTML)||"",null==(e=this.shadowRoot)||e.appendChild(s),o&&(null==(t=this.shadowRoot)||t.appendChild(o))}),super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribeFrom.forEach(e=>e(this))}createCustomColors(){if(!s.f.get("colors"))return;let e=document.createElement("style"),t=Object.entries(s.f.get("colors")).map(([e,t])=>`--${e}: ${t} !important;`).join(" ");return e.innerHTML=`
      * {
        ${t}
      }
    `,e}emitEvent(e,t,i={composed:!0,bubbles:!0}){let o=new CustomEvent(e,(0,s.x)({detail:t},i));this.dispatchEvent(o)}}return i.styles=[n,r,l,a,null!=(t=e.styles)?t:[]],i}},3128:(e,t,i)=>{i.d(t,{E:()=>o,a:()=>s,i:()=>n}),(0,i(6955).e)();var o={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},s=e=>(...t)=>({_$litDirective$:e,values:t}),n=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this.t=e,this._$AM=t,this.i=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}},8947:(e,t,i)=>{i.d(t,{j:()=>v});var o=i(3128),s=i(7128),n=i(6955);(0,n.e)(),(0,n.e)();var{I:r}=s.J,l=()=>document.createComment(""),a=(e,t,i)=>{var o;let s=e._$AA.parentNode,n=void 0===t?e._$AB:t._$AA;if(void 0===i)i=new r(s.insertBefore(l(),n),s.insertBefore(l(),n),e,e.options);else{let t=i._$AB.nextSibling,r=i._$AM,l=r!==e;if(l){let t;null==(o=i._$AQ)||o.call(i,e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==n||l){let e=i._$AA;for(;e!==t;){let t=e.nextSibling;s.insertBefore(e,n),e=t}}}return i},p=(e,t,i=e)=>(e._$AI(t,i),e),d={},c=(e,t=d)=>e._$AH=t,h=e=>e._$AH,w=e=>{var t;null==(t=e._$AP)||t.call(e,!1,!0);let i=e._$AA,o=e._$AB.nextSibling;for(;i!==o;){let e=i.nextSibling;i.remove(),i=e}},u=(e,t,i)=>{let o=new Map;for(let s=t;s<=i;s++)o.set(e[s],s);return o},v=(0,o.a)(class extends o.i{constructor(e){if(super(e),e.type!==o.E.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let o;void 0===i?i=t:void 0!==t&&(o=t);let s=[],n=[],r=0;for(let t of e)s[r]=o?o(t,r):r,n[r]=i(t,r),r++;return{values:n,keys:s}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,o]){var n;let r=h(e),{values:l,keys:d}=this.dt(t,i,o);if(!Array.isArray(r))return this.ut=d,l;let v=null!=(n=this.ut)?n:this.ut=[],g=[],m,_,x=0,f=r.length-1,b=0,y=l.length-1;for(;x<=f&&b<=y;)if(null===r[x])x++;else if(null===r[f])f--;else if(v[x]===d[b])g[b]=p(r[x],l[b]),x++,b++;else if(v[f]===d[y])g[y]=p(r[f],l[y]),f--,y--;else if(v[x]===d[y])g[y]=p(r[x],l[y]),a(e,g[y+1],r[x]),x++,y--;else if(v[f]===d[b])g[b]=p(r[f],l[b]),a(e,r[x],r[f]),f--,b++;else if(void 0===m&&(m=u(d,b,y),_=u(v,x,f)),m.has(v[x])){if(m.has(v[f])){let t=_.get(d[b]),i=void 0!==t?r[t]:null;if(null===i){let t=a(e,r[x]);p(t,l[b]),g[b]=t}else g[b]=p(i,l[b]),a(e,r[x],i),r[t]=null;b++}else w(r[f]),f--}else w(r[x]),x++;for(;b<=y;){let t=a(e,g[y+1]);p(t,l[b]),g[b++]=t}for(;x<=f;){let e=r[x++];null!==e&&w(e)}return this.ut=d,c(e,g),s.E}});(0,n.e)()},459:(e,t,i)=>{function o(e){let t=document.getElementById(`superviz-${e}-styles`);if(!t)return;let i=new CSSStyleSheet;i.replaceSync(t.textContent),this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,i]}i.d(t,{n:()=>o}),(0,i(6955).e)()},746:(e,t,i)=>{i.d(t,{u:()=>r});var o=i(3128),s=i(7128),n=i(6955);(0,n.e)();var r=(0,o.a)(class extends o.i{constructor(e){var t;if(super(e),e.type!==o.E.ATTRIBUTE||"class"!==e.name||(null==(t=e.strings)?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,o;if(void 0===this.st){for(let o in this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),t)t[o]&&!(null!=(i=this.nt)&&i.has(o))&&this.st.add(o);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let i=!!t[e];i===this.st.has(e)||null!=(o=this.nt)&&o.has(e)||(i?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return s.E}});(0,n.e)()},9622:(e,t,i)=>{i.r(t),i.d(t,{WhoIsOnline:()=>u,WhoIsOnlineDropdown:()=>f,WhoIsOnlineMessages:()=>m});var o=i(8947),s=i(6955),n=i(746);i(3128);var r=i(459),l=i(8882),a=i(7128);(0,s.e)(),(0,s.e)(),(0,s.e)(),(0,s.e)();var p=(0,a.C)`
...
`,h=(0,l.D)(a.a),w=[h.styles,p],u=class extends h{constructor(){super(),this.onClickOutDropdown=({detail:e})=>{this.open=e.open},this.toggleShowTooltip=()=>{this.showTooltip=!this.showTooltip},this.dropdownOptionsHandler=({detail:{label:e,participantId:t,source:i}})=>{switch(e){case"go to":this.handleGoTo(t);break;case"follow":this.handleLocalFollow(t,i);break;case"unfollow":this.handleLocalUnfollow();break;case"private mode":this.handlePrivate(t);break;case"leave private mode":this.handleCancelPrivate(t);break;case"everyone follows me":this.handleFollow(t,i);break;case"stop followers":this.handleStopFollow();break;case"gather all":this.handleGatherAll(t)}},this.position="top: 20px; right: 40px;",this.showTooltip=!0,this.open=!1;let{localParticipant:e}=this.useStore("global-store"),{participants:t,following:i,extras:o,disablePresenceControls:s}=this.useStore("who-is-online-store");t.subscribe(e=>{this.participants=e}),i.subscribe(),s.subscribe(),o.subscribe(e=>{this.amountOfExtras=e.length}),e.subscribe(e=>{var t,i;let o=null==(t=e.activeComponents)?void 0:t.some(e=>e.toLowerCase().includes("presence"));this.localParticipantData={id:e.id,joinedPresence:null==(i=e.activeComponents)?void 0:i.some(e=>e.toLowerCase().includes("presence"))},this.disableDropdown=!o})}firstUpdated(e){super.firstUpdated(e),r.n.call(this,"who-is-online")}toggleOpen(){this.open=!this.open}dropdownPosition(e){if(1===this.participants.length)return"bottom-center";if(0===e)return"bottom-right";let t=this.participants.length>4,i=e+1===this.participants.length;return t||!i?"bottom-center":"bottom-left"}renderExtras(){var e;if(!this.amountOfExtras)return;let t={"who-is-online__participant":!0,excess_participants:!0,"excess_participants--open":this.open};return(0,a.V)`
      ...
      >
        <div class=${(0,n.u)(t)} slot="dropdown">
    ...
    >
      ...
      ${(0,o.j)(this.participants,e=>e.id,(e,t)=>{var i;let{avatar:o,id:s,name:r,tooltip:l,controls:p,disableDropdown:d,isLocalParticipant:c}=e,h=this.dropdownPosition(t),w={"who-is-online__participant":!0,"disable-dropdown":d,followed:(null==(i=this.following)?void 0:i.id)===s||this.everyoneFollowsMe&&c,private:c&&this.isPrivate};return(0,a.V)`
            <superviz-dropdown
          ...
          `})}
    `:(0,a.V)``}handleGoTo(e){this.emitEvent("realtime.go-to-participant",{id:e})}handleLocalFollow(e,t){let{following:i}=this.useStore("who-is-online-store"),{id:o,name:s,avatar:{color:n}}=this.useStore("who-is-online-store")[t].value.find(({id:t})=>t===e);this.everyoneFollowsMe&&this.handleStopFollow(),i.publish({name:s,id:o,color:n}),this.emitEvent("realtime.local-follow-participant",{id:o,source:t})}handleLocalUnfollow(){let{following:e}=this.useStore("who-is-online-store");e.publish(void 0),this.emitEvent("realtime.local-follow-participant",{id:void 0})}handlePrivate(e){this.everyoneFollowsMe&&this.handleStopFollow(),this.emitEvent("realtime.private-mode",{id:e,isPrivate:!0}),this.isPrivate=!0}handleCancelPrivate(e){this.emitEvent("realtime.private-mode",{id:e,isPrivate:!1}),this.isPrivate=!1}handleFollow(e,t){this.isPrivate&&this.cancelPrivate();let{id:i,name:o,avatar:{color:s}}=this.useStore("who-is-online-store")[t].value.find(({id:t})=>t===e);this.everyoneFollowsMe=!0;let{following:n}=this.useStore("who-is-online-store");n.publish(void 0),this.emitEvent("realtime.follow-participant",{id:i,name:o,color:s})}handleStopFollow(){this.everyoneFollowsMe=!1,this.emitEvent("realtime.follow-participant",void 0)}handleGatherAll(e){this.isPrivate&&this.cancelPrivate(),this.emitEvent("realtime.gather",{id:e})}updated(e){super.updated(e),this.updateComplete.then(()=>{let e=this.shadowRoot.querySelector(".who-is-online");if(!e)return;let t=this.position.includes("left")?"flex-start":"flex-end",i=`${this.position} align-items: ${t};`;e.setAttribute("style",i)})}render(){return(0,a.V)`<div class="who-is-online who-is-online">
    ...
    >
      ${i}
    </div>`}renderParticipants(){if(!this.participants)return;let e=this.participants.length-1;return(0,o.j)(this.participants,e=>e.id,(t,i)=>{let{disableDropdown:o,id:s,avatar:r,controls:l,tooltip:p,name:d}=t,c={"who-is-online__extra-participant":!0,"who-is-online__extra-participant--selected":this.selected===s,"disable-dropdown":o};return(0,a.V)`
        <superviz-dropdown
        ...
        <div 
          ...
          @click=${this.selectParticipant(s,o)} slot="dropdown">
            ...
            <superviz-icon 
              class=${(0,n.u)({"who-is-online__extras__arrow-icon":!0,"hide-icon":o})} 
              name="right" 
      ...
      <div class="dropdown-list">
        <div class=${(0,n.u)(this.menuClasses)}>${this.renderParticipants()}</div>
      </div>
    `}};f.styles=x,f.properties={open:{type:Boolean},align:{type:String},position:{type:String},selected:{type:String},disableDropdown:{type:Boolean},showSeeMoreTooltip:{type:Boolean},showParticipantTooltip:{type:Boolean},localParticipantJoinedPresence:{type:Boolean},dropdownList:{type:Object}},f=(0,s.D)([(0,a.t)("superviz-who-is-online-dropdown")],f)}};